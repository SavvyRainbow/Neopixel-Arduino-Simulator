...
function newStrip(name, numLEDs, parent=document.getElementById("stripContainer")) {
    ...
    strip.show = () => {}; // DOM is updated instantly
    strip.setPixelColor = (i, color) => {
        if (i >= 0 && i < strip.numPixels()) strip.leds[i].style.backgroundColor = color;
    };
...
// Preprocess Arduino code: convert int -> let
